                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            {{--<input type="text" class="form-control" --}}{{--wire:model.defer="nombre"--}}{{-- placeholder="[numerico]">--}}
                            {{--{!! Form::select('sexo', $eventos, null , ['class' => 'custom-select', 'wire:model' => 'select', 'placeholder' => 'Seleccione']) !!}--}}
